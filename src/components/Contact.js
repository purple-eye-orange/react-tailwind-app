    ...
    <section name="contact" className='w-full h-screen p-4'>
      <div className='flex flex-col justify-center h-full max-w-screen-lg p-4 mx-auto'>
        <div className='text-center'>
          ...
          <p className='py-6 text-3xl text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus condimentum sapien nisi, ac aliquet lorem eleifend id.</p>
        </div>
        ...
        <div className='flex items-center justify-center mt-10'>
          <form className='flex flex-col w-full md:w-1/2'>
            ...
            <button
              className='duration-300 bg-gradient-to-b from-cyan-500 to-blue-500 hover:scale-110 my-8 mx-auto px-6 py-3'
              >
              Let's Talk
            </button>
          </form>
