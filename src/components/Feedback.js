...
const Feedback = () => {
  ...
  return (
    <section name='textimonials' className='w-full my-24 text-white bg-slate-700'>
      <div className='max-w-6xl px-5 mx-auto text-center py-12'>
        ...
        <p className='py-8 text-2xl text-white'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus condimentum sapien nisi, ac aliquet lorem eleifend id.
        </p>

        <div className='flex flex-col mt-24 md:flex-row md:space-x-6'>
          <div className='flex flex-col items-center p-6 space-y rounded-lg bg-gray-100/30 md:w-1/3'>
          ...
          <div className='hidden md:flex flex-col items-center p-6 space-y rounded-lg bg-gray-100/30 md:w-1/3'>
            <img src={image} className='w-16 -mt-14 rounded-full' alt='person' />
            <h5 className='text-lg font-bold'>Ali ko</h5>
            <p className='text-sm'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus condimentum sapien nisi, ac aliquet lorem eleifend id.
